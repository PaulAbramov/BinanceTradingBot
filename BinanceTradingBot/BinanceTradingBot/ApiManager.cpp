...
string ApiManager::GetMarketDataTime() const
{
	string postData;
	string strResult;
...
string ApiManager::GetMarketDataCandlestick(const string& _symbol, EIntervals _interval, time_t _startTime, time_t _endTime, int _limit) const
{
	string postData;
	string strResult;
	const string action{ "GET" };
...
string ApiManager::GetMarketDataSymbolPriceTicker(const string& _symbol) const
{
	string postData;
	string strResult;
	const string action{ "GET" };
...
*/
string ApiManager::GetSpotAccountCurrentOrderCountUsage() const
{
	string postData;
	string strResult;
	const string action{ "GET" };
...
*/
string ApiManager::GetSpotAccountTradeList(const string& _symbol, const unsigned short _orderId, const time_t _startTime, const time_t _endTime, const unsigned short _fromId, const int _limit) const
{
	string postData;
	string strResult;
	const string action{ "GET" };
...
string ApiManager::GetSpotAccountInformation() const
{
	string postData;
	string strResult;
	const string action{ "GET" };
...
string ApiManager::GetSpotAccountQueryOpenOco() const
{
	string postData;
	string strResult;
	const string action{ "GET" };
...
*/
string ApiManager::GetSpotAccountQueryAllOco(const unsigned short _fromId, const time_t _startTime, const time_t _endTime, const int _limit) const
{
	string postData;
	string strResult;
	const string action{ "GET" };
...
*/
string ApiManager::GetSpotAccountQueryOco(const unsigned short _orderListId, const string& _originalClientOrderId) const
{
	string postData;
	string strResult;
	const string action{ "GET" };
...
*/
string ApiManager::DeleteSpotAccountCancelOco(const string& _symbol, const unsigned short _orderListId,
...
*/
string ApiManager::PostSpotAccountNewOcoOrder(const string& _symbol, const string& _listClientOrderId, const string& _quantity,
...
*/
string ApiManager::GetSpotAccountAllOrders(const string& _symbol, const unsigned short _orderId, const time_t _startTime, const time_t _endTime, const int _limit) const
{
	string postData;
	string strResult;
	const string action{ "GET" };
...
*/
string ApiManager::GetSpotAccountCurrentOpenOrders(const string& _symbol) const
{
	string postData;
	string strResult;
	const string action{ "GET" };
...
* For some historical orders cummulativeQuoteQty will be < 0, meaning the data is not available at this time.
*/
string ApiManager::GetSpotAccountQueryOrder(const string& _symbol, const unsigned short _orderId, const string& _originalClientOrderId) const
{
	string postData;
	string strResult;
	const string action{ "GET" };
...
* symbol			STRING			YES
*/
string ApiManager::DeleteSpotAccountCancelAllOpenOrdersOnSymbol(const string& _symbol) const
{
	string postData;
	string strResult;
	const string action{ "DELETE" };
...
* Either orderId or origClientOrderId must be sent.
*/
string ApiManager::DeleteSpotAccountCancelOrder(const string& _symbol, const unsigned short _orderId, const string& _originalClientOrderId, const string& _newClientOrderId) const
{
	string postData;
	string strResult;
	const string action{ "DELETE" };
...
*/
string ApiManager::PostSpotAccountNewOrder(const string& _symbol, const ETimeInForce _timeInForce, const string& _quantity,
...
*/
string ApiManager::GetWalletAllCoinsInformation() const
{
	string postData;
	string strResult;
	const string action{ "GET" };
...
*/
string ApiManager::GetWalletDailyAccountSnapshot(const ESnapshotType _snapshotType, const time_t _startTime, const time_t _endTime, const int _limit) const
{
	string postData;
	string strResult;
	const string action{ "GET" };
...
*/
string ApiManager::PostWalletWithdraw(const string& _coin, const string& _withdrawOrderId, const string& _network, const string& _address, const string& _addressTag, const string& _amount, const string& _name, const bool _transactionFeeFlag) const
{
	string postData;
	string strResult;
	const string action{ "POST" };
...
*/
string ApiManager::GetWalletDepositHistory(const string& _coin, const int _status, const time_t _startTime, const time_t _endTime, const int _offset, const int _limit) const
{
	string postData;
	string strResult;
	const string action{ "GET" };
...
* If both startTime and endTime are sent, time between startTime and endTime must be less than 90 days.
*/
string ApiManager::GetWalletWithdrawtHistory(const string& _coin, const string& _withdrawOrderId, const int _status, const time_t _startTime, const time_t _endTime, const int _offset, const int _limit) const
{
	string postData;
	string strResult;
	const string action{ "GET" };
...
*/
string ApiManager::GetWalletDepositAddress(const string& _coin, const string& _network) const
{
	string postData;
	string strResult;
	const string action{ "GET" };
...
* make a webrequest
*/
void ApiManager::CurlAPIWithHeader(string& _url, string& _strResult, string& _postData, const string& _action, string& _queryString, const bool _setSecretAndApiKey, bool _getServerTime) const
{
...
void ApiManager::SetSecretAndApiKeyInUrl(string& _url, vector <string>& _extraHttpHeader, string _querystring) const
{
...
void ApiManager::SetSecretAndApiKeyInPostData(vector<string>& _extraHttpHeader, string& _postData) const
{
...
*/
size_t ApiManager::WebRequestCallback(void* _content, const size_t _size, const size_t _nmemb, string* _buffer)
{
...
string ApiManager::B2AHex(const unsigned char* _byteArray, int _n)
{
...
void ApiManager::CurlAPI(string& _url, string& _stringResult, bool _getServerTime) const
{
	if (_getServerTime)
	{
		auto timeString{ GetMarketDataTime() };
...
void ApiManager::PerformCurl(CURL* _curl) const
{
